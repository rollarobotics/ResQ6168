...
public class BigBerthaTelemetry extends BigBerthaHardware
{
    ...
    public void updateGamepadTelemetry () {
        ...
        telemetry.addData ("021", "Bucket Door GP1 Y: "+ gamepad1.y);
        telemetry.addData ("022", "Bucket Door GP1 X: "+ gamepad1.x);
        telemetry.addData ("03" , "Man GP2 A: "        + gamepad2.a);
        telemetry.addData ("04" , "Man GP2 B: "        + gamepad2.b);
        telemetry.addData ("05" , "Hook GP2 Y: "       + gamepad2.y);
        telemetry.addData ("06" , "Hook GP2 X: "       + gamepad2.x);
        ...
        telemetry.addData ("09" , "Right Arm GP2 Right Stick: "  +zero(-gamepad2.right_stick_y));
        telemetry.addData ("091", "Left Arm GP2 Left Stick:  "   +zero(-gamepad2.left_stick_y));
        telemetry.addData ("10" , "Bucket GP2 Dpad Up: "              + gamepad2.dpad_up);
        telemetry.addData ("11" , "Bucket GP2 Dpad Down: "            + gamepad2.dpad_down);
        ...
        telemetry.addData ("16" , "Right Lift GP2 Right Trigger: "    + gamepad2.right_trigger);
        telemetry.addData ("17" , "Left Lift GP2 Left Trigger: "      +-gamepad2.left_trigger);
        telemetry.addData ("171", "Back Right Lift GP2 Right Bumper: "+ gamepad2.right_bumper);
        telemetry.addData ("172", "Back Left Lift GP2 Left Bumper: "  + gamepad2.left_bumper);
    ...
    public void updateTelemetry () {
        ...
        telemetry.addData ("211", "Flag Servo Position: "       + getFlagPosition());
        ...
        telemetry.addData ("231", "Back Right Power: " + getBackRightPower() + ", " + getRightEncoderCount());
        telemetry.addData ("232", "Back Left Power: "  + getBackLeftPower()  + ", " + getLeftEncoderCount());
        telemetry.addData ("24" , "Right Arm Power: "  + getRightArmPower()  + ", " + getLiftArmEncoderCount());
        telemetry.addData ("24" , "Left Arm Power: "   + getLeftArmPower()   + ", " + getLiftArmEncoderCount());
        telemetry.addData ("25" , "Right Lift Power: " + getRightLiftPower() + ", " + getLiftEncoderCount());
        telemetry.addData ("251", "Left Lift Power: "  + getLeftLiftPower()
                + ", " + getLiftEncoderCount());
